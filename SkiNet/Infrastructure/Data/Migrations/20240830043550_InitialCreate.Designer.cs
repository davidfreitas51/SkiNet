...
namespace SkiNet.Migrations
{
    ...
    [Migration("20240830043550_InitialCreate")]
            ...
            modelBuilder.Entity("Product", b =>
                {
                    ...
                    b.Property<int>("ProductBrandbyId")
                        .HasColumnType("int");

                    b.Property<int>("ProductTypeById")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProductBrandbyId");

                    b.HasIndex("ProductTypeById");
            ...
            modelBuilder.Entity("Product", b =>
                {
                    b.HasOne("SkiNet.Domain.Entities.ProductBrand", "ProductBrand")
                        .WithMany()
                        .HasForeignKey("ProductBrandbyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SkiNet.Domain.Entities.ProductType", "ProductType")
                        .WithMany()
                        .HasForeignKey("ProductTypeById")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
